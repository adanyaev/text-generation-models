...
def main():
    ...
    if args.command == "train":
        training_text = " ".join(open(args.input, encoding='utf-8'))
        training_text = training_text.replace(u'\xa0', ' ')
        ...
        if not os.path.exists(args.vocab):
            ...
            sys.exit(1)
        vocab = Vocabulary.load(open(args.vocab, encoding='utf-8'))
